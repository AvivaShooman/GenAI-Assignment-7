...
def main():
    ...
    with st.sidebar:
        ...
        - **StartupMasterclass** - Expert guidance from the 'How to Start a Startup' course materials
    ...
    if "agent_executor" not in st.session_state:
        with st.spinner("Initializing AI models and knowledge bases..."):
            ...
            startup_masterclass_rag_chain = get_startup_masterclass_chain(llm, embedding)
    ...
    # Chat input
    query = st.chat_input("Ask me about startups, legal information, or get expert startup advice from course materials...")
